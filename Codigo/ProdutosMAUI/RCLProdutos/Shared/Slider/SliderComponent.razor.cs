...
namespace RCLProdutos.Shared.Slider
{
    public partial class SliderComponent
    {
        ...
        private List<ProdutoDTO>? userFavoritos { get; set; }
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            try
            {
                ...
                {
                    userFavoritos = await _apiServices!.GetFavoritos();
                ...
                int sugestaoProdutoId = random.Next(produtos.Count); 
                sugestaoProduto = produtos[sugestaoProdutoId];
