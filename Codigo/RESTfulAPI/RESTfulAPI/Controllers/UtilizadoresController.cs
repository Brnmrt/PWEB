...
public class UtilizadoresController : ControllerBase
{
    ...
    public async Task<IActionResult> LoginUser([FromBody] Utilizador utilizador)
    {
        ...
        if (result.Succeeded)
        {
            ...
            var credentialtokens = new SigningCredentials(securityKey, SecurityAlgorithms.HmacSha256);
            ...
            return new ObjectResult(new
            {
                accesstoken = jwt,
                tokentype = "bearer",
                utilizadorid = tempUser.Id,
                utilizadornome = tempUser.Nome,
                utilizadorestado = tempUser.Estado,
                roles = userRoles
