...
namespace GestaoLoja.Migrations
{
    ...
    [Migration("20250102160326_DBV15")]
    partial class DBV15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoLoja.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("produtosFavoritos")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GestaoLoja.Entities.Classificacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestaoLoja.Entities.Marca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestaoLoja.Entities.Encomenda", b =>
                {
                    ...
                    b.HasOne("GestaoLoja.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("GestaoLoja.Entities.Produto", b =>
                {
                    ...
                    b.HasOne("GestaoLoja.Entities.Classificacao", "classificacao")
                        .WithMany()
                        .HasForeignKey("ClassificacaoId");

                    b.HasOne("GestaoLoja.Entities.Marca", "marca")
                        .WithMany()
